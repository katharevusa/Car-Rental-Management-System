...
public class Main {
    ...
    private static CustomerEntity currentCustomer;
    ...
    public static void registerCustomer() throws CustomerNotFoundException_Exception{
        ...
        sc.nextLine();
        try{
            currentCustomer = retrieveCustomerByCustomerId(customerId);
        } catch (CustomerNotFoundException_Exception ex){
            throw new CustomerNotFoundException_Exception("Customer Id " + customerId + " does not exist.");
        }
                ...
                if (canReserve) {
                    ...
                    if (confirmReservation.equals("Y")) {
                        ...
                        Long reservationId = createNewReservationRecord(totalRentalRate, selectedModelId, selectedCategoryId,
                                xmlPickupDateTime, xmlReturnDateTime, selectedPickupOutletId, selectedReturnOutletId, ccNumber, paidAmt,currentCustomer.getCustomerId(),currentPartner.getPartnerId());
    ...
    private static void doViewAllReservation() {
        ...
        try {
            ...
            for (ReservationRecordEntity reservation : reservationRecordEntities) {
                if (retrievePartnerIdByReservationId(reservation.getReservationRecordId()).equals(currentPartner.getPartnerId())) {
    ...
    public static void doCancelReservation(Long reservationId) {
    ...
    private static Long retrievePartnerIdByReservationId(java.lang.Long arg0) throws ReservationRecordNotFoundException_Exception {
        ws.client.CaRMSWebService_Service service = new ws.client.CaRMSWebService_Service();
        ws.client.CaRMSWebService port = service.getCaRMSWebServicePort();
        return port.retrievePartnerIdByReservationId(arg0);
    }
