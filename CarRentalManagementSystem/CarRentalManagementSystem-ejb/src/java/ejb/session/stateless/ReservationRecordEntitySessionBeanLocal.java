...
public interface ReservationRecordEntitySessionBeanLocal {
    ...
    public Long createReservationRecordForWebClient(double totalRentalRate, Long selectedModelId, Long selectedCategoryId, LocalDateTime pickupDateTime, LocalDateTime returnDateTime, Long selectedPickupOutletId, Long selectedReturnOutletId, String ccNumber, double paidAmt, Long customerId, Long partnerId) throws ReservationCreationException;
